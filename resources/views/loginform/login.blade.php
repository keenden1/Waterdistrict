...
<div class="split-form">
    <div class="image-side">
        <h2 class="text-1">Welcome Back!</h2>
    ...
    <form method="POST" action="{{ route('Login-User') }}" id="user-login-form">
      ...
      <button type="submit" id="user-login-button" style="margin-top: 0;">
        ...
        <p class="link-text">Doesn't have an account? <a href="{{ url('/Register') }}">Register</a></p>

        <p class="forgot-password-text"><a href="{{ url('/forgotpassword') }}">Forgot Password?</a></p>
    </div>
</div>
