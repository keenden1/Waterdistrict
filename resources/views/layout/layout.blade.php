  ...
  <div class="l-navbar" id="nav-bar">
    <nav class="nav">
      <div class="nav__list"> 
        ...
        <a href="{{ url('/Admin-Dashboard') }}" class="nav__link active" id="active">
          <i class='bx bxs-home nav__icon'></i>
          <span class="nav__name">Dashboard</span>
        </a>
        <a href="{{ url('/Admin-Application-Leave') }}" class="nav__link " id="active">
          <i class='bx bx-grid-alt nav__icon'></i>
          <span class="nav__name">Application for Leave</span>
        </a>
        <a href="{{ url('/Admin-Terminal-Leave') }}" class="nav__link" id="active">
          <i class='bx bx-terminal nav__icon'></i>
          <span class="nav__name">Terminal Leave</span>
        </a>
        <a href="{{ url('/Admin-Leave-Credit-Card') }}" class="nav__link" id="active">
          <i class='bx bx-card nav__icon'></i>
          <span class="nav__name">Leave Credit Card</span>
        </a>
        <a href="{{ url('/Admin-Employee-Account') }}" class="nav__link" id="active">
          <i class='bx bxs-user-account nav__icon'></i>
          <span class="nav__name">Employee Account</span>
        </a>

        <a href="{{ url('/Admin-Summary') }}" class="nav__link" id="active">
          <i class='bx bx-note nav__icon'></i>
          <span class="nav__name">Summary</span>
        </a>

        <div class="nav__bottom">
        <a href="{{ url('/Admin-Control-Panel') }}" class="nav__link" id="active">
          <i class='bx bxs-edit-alt nav__icon'></i>
          <span class="nav__name">Control Panel</span>
        </a>
