...
@section('title', 'Summary-Of-Absence')
@section('header_title', "SUMMARY OF ABSENCE")
@section('content')
<div id="section">
  <div class="image-side">
  
  <img src="{{ asset('logo/logo.png') }}" alt="Villasis Water District" class="image-side-img">
  <h2>SUMMARY ABSENCE FORM</h2>
  </div>
  <div class="container" id="container">
    <form action="{{ route('Admin-Summary-Generate-page') }}" method="POST">
      @csrf
