...
<div class="split-form">
    ...
    <input type="text" name="fname" placeholder="First Name" value="{{ old('fname') }}" required style="text-transform: capitalize;">
    <input type="text" name="mname" placeholder="Middle Name" value="{{ old('mname') }}" style="text-transform: capitalize;">
    <input type="text" name="lname" placeholder="Last Name" value="{{ old('lname') }}"  required style="text-transform: capitalize;">
    </div>
    ...
    <input type="text" name="position" placeholder="Position" value="{{ old('position') }}" required style="text-transform: capitalize;">
    @error('position')
        <span class="text-danger">{{ $message }}</span>
    @enderror
